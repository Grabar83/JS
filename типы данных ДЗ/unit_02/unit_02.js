...
function t10() {
    ...
    console.log(i_10);
    document.querySelector('.out-10').innerHTML = i_10 * 20;
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = i11 + 55;
}
...
function t12() {
    let i12_1 = document.querySelector('.i-12-1').value;
    let i12_2 = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').textContent = 'Hello' + ' ' + i12_1 + ' ' + i12_2;
}
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = i16_1 + i16_2;
}

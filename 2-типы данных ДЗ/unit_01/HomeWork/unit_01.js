...
let task7 = document.getElementById('seven');
task7.innerHTML = (12*12);

// console.log(task7);

// Task 8.
// На странице создан div.out-8. С помощью document.querySelector запишите в данный элемент текст 'task-8'. 
let task8 = document.querySelector('.out-8');
// console.log(task8);
task8.innerHTML = 'task-8';
...
document.querySelector('.out-11').innerHTML += '789*';

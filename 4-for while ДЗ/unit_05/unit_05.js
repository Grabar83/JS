...
function t12() {
    ...
    for (i = 0; i < elem.length; i++) {
        document.querySelector('.out-12').innerHTML += elem[i].innerHTML + '<br>';
    }
}
...
function t13() {
    ...
    for (let i = 0; i < i13.length; i++) {
        ...
        // console.log(i13);
        // document.querySelector('.i-13').innerHTML == i13.innerHTML;
    }
...
// вывести в .elem value выбранного. Проверить выбран ли элемент можно с помощью elem[i].checked.
...
function t15() {
    for (let i = 0; i < 11; i++) {
        document.querySelector('.out-15').innerHTML += `${10-i}_${i}_`
    }
}

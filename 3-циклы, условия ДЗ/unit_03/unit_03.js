...
function f11() {
   ...
   switch (s110) {
      case '6':
         document.querySelector('.out-11').innerHTML = 'six'
         break;
      case '7':
         document.querySelector('.out-11').innerHTML = 'seven'
         break;
      case '11':
         document.querySelector('.out-11').innerHTML = 'eleven'
         break;
      case '9':
         document.querySelector('.out-11').innerHTML = 'nine'
         break;
   }
}
